package require pbctools
        mol new ../../minimization_33_NVT_cons_5/dump.nvt10.lammpstrjdump type lammpstrj first 0 last -1 step 1 filebonds 1 autobonds 1 waitfor all
	pbc wrap -center com -all
	set num_frames_total 0
	set output [open "out.numtris" "w"]
	...
	set s1 [atomselect top "type 20 and -41.5<z and z<41.5 and x*x+y*y<480" frame $i]
